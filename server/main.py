...
HTTP_SERVER_USE_TLS = True
HTTP_SERVER_PERSIST = True
HTTP_SERVER_TIMEOUT = 10
HTTP_SERVER_VERBOSE = True
HTTP_SERVER_CERT = os.path.join(ROOT_DIR, "cert", "test.code-workspace.cloud_bundle.pem")
HTTP_SERVER_KEY = os.path.join(ROOT_DIR, "cert", "test.code-workspace.cloud.key")
